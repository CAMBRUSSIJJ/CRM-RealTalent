...
- `HOMOLOGATION-REPORT-V100-38.json` aprovado;
- `DATABASE-AUDIT-V100-38.json` aprovado;
- `PRE-FLIGHT-V100-38.json` aprovado;
- `RELEASE-MANIFEST-V100-38.json` gerado;
