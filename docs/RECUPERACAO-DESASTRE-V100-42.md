# Recuperação de desastre — V100.42
...
## Recuperação de comunicações

Antes de reativar workers após uma restauração, valide idempotência do outbox, assinaturas externas e vínculos de calendário. Reprocesse itens somente pelos identificadores registrados para evitar mensagens e eventos duplicados.
