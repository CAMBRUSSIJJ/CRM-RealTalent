...
check('Bridge V100.46.2', page.includes("version: '100.46.2'") && page.includes('__REALTALENT_LEAD_MAP_BRIDGE__'), 'ponte React/runtime')
...
check('Documentação do módulo', exists('docs/MAPA-DE-LEADS-V100-46-2.md'), 'implantação e operação')
